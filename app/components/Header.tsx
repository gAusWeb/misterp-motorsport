    ...
    <>
          ...
          <div>
            <a href="/" className="block">
              ...
              <h3 className="inline-flex">
                <span>
                  Mis-terp <span style={{ color: "#ffd518" }}>Motorsports</span>
                </span>
              </h3>
            </a>
          </div>
      ...
      {/* <nav className="flex items-center justify-between flex-wrap bg-white p-6">
        ...
        <div className="block lg:hidden">
          <button className="flex items-center px-3 py-2 border rounded text-blue-500 border-teal-400 hover:text-white hover:border-white">
            <svg
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            <a
              href="/blogs"
              className="block mt-4 lg:inline-block lg:mt-0 text-blue-500 hover:text-white mr-4"
            >
              Blogs
            </a>
            <a
